public class Main {
    ...
    public static void task2() {
        System.out.println("_______________________________________Задача №2________________________________________");
        String firstName = "Ivan ";
        String middleName = "Ivanovich ";
        String lastName = "Ivanov ";
    ...
    public static void task3() {
        System.out.println("_______________________________________Задача №3________________________________________");
